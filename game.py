...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, clearTroops, move_superArchers, spawnSuperArcher, move_healers, spawnHealer
...
while(True):
    ...
    move_balloons(V)
    # new troops
    move_superArchers(V,pt.movement)
    move_healers(V)
